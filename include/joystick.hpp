...
public:
   ...
   * internal data structu            // Pantilt
            if(robotButton.enableRoll && robotButton.enableYaw) robotState = robotStates::pantiltRoll;
            else if(robotButton.enableRoll) robotState = robotStates::pantiltYaw;
            else if(robotButton.enableYaw) robotState = robotStates::pantiltRoll;
            else robotState = robotStates::idle;res.
   */
...
public:
  ...
  void closeDevice(); // close joystick
